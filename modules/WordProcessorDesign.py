...
"}")
        ...
        self.insert_image = QtWidgets.QPushButton(self.toolBar)
        self.insert_image.setText("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("../icons/photo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.insert_image.setIcon(icon10)
        self.insert_image.setObjectName("pushButton")
        self.horizontalLayout_2.addWidget(self.insert_image)
